...
class RestAPIBookTest(unittest.TestCase):
    ...
    def test_book_get(self):
        ...
        resp = self.app.post('/book/get', data=json.dumps(dict({'_id': books[0]['_id'].replace('1', '0')})), content_type='application/json')
    ...
    def test_book_update(self):
        ...
        resp = self.app.post('/book/update', data=json.dumps(dict({'token': token, '_id': books[0]['_id'].replace('1', '0')})), content_type='application/json')
        self.assertEqual(resp.status_code, 404)
